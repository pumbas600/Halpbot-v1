...
//        SimpleParsingToken token = new SimpleParsingToken(false, float[].class, "[1 4.5 3.1]");
//
...
//        Assertions.assertEquals(0, ((float[])result.get()).length);
...
//
//        Assertions.assertTrue(result.present());
//        Assertions.assertEquals(1.3F, result.get()[0]);
//        Assertions.assertEquals(4.7F, result.get()[1]);
//        Assertions.assertEquals(3F, result.get()[2]);
//    }
//
//    @Test
...
//
//        Assertions.assertTrue(token.parse(InvocationContext.of("x")).present());
//        Assertions.assertTrue(token.parse(InvocationContext.of("X-axis")).present());
//        Assertions.assertTrue(token.parse(InvocationContext.of("y")).present());
//        Assertions.assertTrue(token.parse(InvocationContext.of("y-Axis")).present());
...
//
//        Assertions.assertTrue(multiChoiceToken.parse(InvocationContext.of("x-axis")).present());
//        Assertions.assertTrue(multiChoiceToken.parse(InvocationContext.of("Y-axis")).present());
//        Assertions.assertFalse(multiChoiceToken.parse(InvocationContext.of("axis")).present());
//    }
...
//
//        Assertions.assertTrue(token.parse(InvocationContext.of("Square")).present());
//        Assertions.assertTrue(token.parse(InvocationContext.of("Circle")).present());
//        Assertions.assertFalse(token.parse(InvocationContext.of("1")).present());
//        Assertions.assertFalse(result.present());
//        Assertions.assertTrue(result.hasReason());
...
//
//        Assertions.assertTrue(squareResult.present());
//        Assertions.assertTrue(rectangleResult.present());
//
//        Assertions.assertFalse(falseResult1.present());
...
//
//        Assertions.assertFalse(falseResult2.present());
...
//
//        Assertions.assertEquals(4, squareResult.get().getArea());
//        Assertions.assertEquals(2, rectangleResult.get().getArea());
//    }
//
//    @Test
...
//
//        Assertions.assertTrue(result.present());
//        Assertions.assertEquals(4, result.get().getDeterminant());
//    }
//
//    @Test
...
//
//        Assertions.assertTrue(result1D.present());
//        Assertions.assertTrue(result2D.present());
//
//        Assertions.assertFalse(resultMissingBracket.present());
